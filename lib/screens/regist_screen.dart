          ...
          () => Stack(
            children: [
              ClipPath(
                ...
                child: Container(
                  color: Color.fromARGB(255, 127, 82, 91),
                  height: 100,
                ),
              ),
              Column(
                ...
                children: [
                  Column(
                    children: [
                      ...
                      SizedBox(height: 20.0),
                      buildTextBox(
                        controller.passwordEditor.value,
                      ...
                      SizedBox(height: 20.0),
                      buildTextBox(
                        controller.confirmPasswordEditor.value,
                        (!controller.isNeedConfirmPassword.value ? textBorder : errorBorder),
                        Icons.key,
                        'パスワード再入力',
                        isPass: true,
                        horizontalPadding: (isIpad ? size.width / 4 : null),
                          ...
                          () async {
                            ...
                            await PanaraConfirmDialog.show(
                              ...
                              onTapConfirm: () async {
                                ...
                                final message = await controller.regist();
                                setState(() {
